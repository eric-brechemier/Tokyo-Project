...
The prototype was successfully ended between August 15th and August 16th 2005:
the objectives are fulfilled; without any modification to Saxon processor code,
...
DEPENDENCIES (included in distribution packages)

  Saxon 6.5.4 library 
    Can be downloaded from http://saxon.sourceforge.net/
    (direct download: http://prdownloads.sourceforge.net/saxon/saxon6-5-4.zip)

  XMLPull 1.1.3.4 API library
    Can be downloaded from http://www.xmlpull.org
    (direct download: http://www.xmlpull.org/v1/download/xmlpull_1_1_3_4b.jar)
