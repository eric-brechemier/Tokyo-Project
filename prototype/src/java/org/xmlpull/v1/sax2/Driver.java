...
// for license please see accompanying LICENSE.txt file (text copied below) (available also at http://www.xmlpull.org/)
                ...
                switch(type) {
                    case XmlPullParser.START_TAG:
                        if(namespaceAware) {
                            ...
                            {
                                // Eric Bréchemier: ERROR in original implementation:
                                // in XmlPullParser:
